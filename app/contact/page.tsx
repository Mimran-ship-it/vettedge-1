  ...
  const contactMethods = [
    {
      ...
      action: "Send Email",
      link: "https://mail.google.com/mail/u/0/?fs=1&to=support@vettedge.domains&tf=cm",
      isExternal: true,
    },
    {
      icon: MessageSquare,
  ...
  const officeInfo = [
    {
      ...
      details: [
        ...
        "Looking for niche-specific names or bulk deals?",
      ],
    },
    {
      icon: CheckCircle,
      title: "Post-Purchase Help",
      details: [
        "Get help with domain access",
        "Transfer guidance",
    ...
    },
    {
      ...
      title: "Response Time",
      details: [
        "We aim to respond to all support and sales inquiries",
      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center space-y-8">
          ...
          <p className="text-lg md:text-xl lg:text-2xl text-[#33BDC7] max-w-3xl mx-auto leading-relaxed">
            Have questions about domains? Need help with your purchase? Our
      ...
      <section className="py-16 bg-white dark:bg-gray-900">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div
            ...
            variants={fadeUp}
          >
            <h2 className="text-2xl md:text-3xl font-bold text-[#33BDC7] dark:text-[#33BDC7] mb-4">
              ...
              >
                <Card className="text-center hover:shadow-lg transition-all duration-300 border-2 hover:border-[#33BDC7] dark:bg-gray-700 dark:border-gray-600">
                  <CardContent className="pt-8 pb-6">
                    ...
                    <h3 className="text-lg md:text-xl font-semibold text-[#33BDC7] dark:text-[#33BDC7] mb-2">
                      {method.title}
                    </h3>
                    ...
                    {method.isExternal ? (
                      ...
                      <Button
                        ...
                        className="bg-[#33BDC7] hover:from-[#33BDC7]"
                      >
                        {method.action}
                      </Button>
                    )}
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    ...
                    <div className="text-center space-y-2">
                      ...
                      <p className="text-gray-600 dark:text-gray-300 text-sm leading-relaxed">
                        Need help choosing the right domain? Looking for
                        niche-specific names or bulk deals?
                      </p>
                    </div>
                    ...
                    <div className="text-center space-y-2">
                      ...
                      <p className="text-gray-600 dark:text-gray-300 text-sm leading-relaxed">
                        Get help with domain access, transfer guidance, and
                        account-related questions.
                      </p>
                    </div>
              ...
              <Card className="shadow-xl border-0">
                <CardHeader>
                  ...
                  <p className="text-gray-600 dark:text-gray-300">
                    {contactMethods[0].description}
                  </p>
                </CardHeader>
                <CardContent>
                  <ContactForm variant="contact" showHeader={false} />
                </CardContent>
              </Card>
            </motion.div>
          </div>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="space-y-6">
            {[
              {
                question:
                  "Can I request a specific niche or category of domain?",
                answer:
                  "Absolutely. Contact us with your preferred niche or keywords and we'll suggest available options or source domains for you.",
              },
              {
                question: "Do you offer refunds?",
                answer:
                  "Yes — we offer a 14-day refund policy. A 5% handling fee applies, and payment gateway fees (like PayPal's) are non-refundable. Domains must be unused and returned to us.",
              },
              {
                question: "Are Aged Domains safe to use for SEO?",
                answer:
                  "If properly vetted — yes. We only sell aged/Aged Domains with clean histories and strong SEO potential, making them ideal for authority sites, PBNs, niche blogs, or brand foundations.",
              },
              {
              ...
              },
              {
                ...
                answer:
                  "Yes. Every domain we list is manually vetted to ensure it's free from spam, Google penalties, or blacklists.",
              },
              {
                question: "Can I request backlink or SEO metrics for a domain?",
                answer:
                  "Definitely. Contact us and we'll provide a snapshot of the domain's metrics — such as referring domains, domain authority, and other relevant data.",
              },
