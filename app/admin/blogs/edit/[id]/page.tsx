  ...
  useEffect(() => {
    const load = async () => {
      try {
        ...
        const b: BlogPost = await res.json();
        setFormData({
          slug: b.slug,
          title: b.title,
          excerpt: b.excerpt,
          ...
          publishedAt: new Date(b.publishedAt).toISOString().slice(0, 10),
          readingTime: String(b.readingTime),
          category: b.category,
          featured: b.featured,
          image: b.image,
        });
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    try {
      const body = {
        ...
        author: { name: formData.authorName, avatar: formData.authorAvatar },
                ...
                <CardContent className="space-y-4">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    ...
                    <div>
                      ...
                      <Input id="authorAvatar" name="authorAvatar" value={formData.authorAvatar} onChange={handleChange} required />
                    </div>
                  </div>
